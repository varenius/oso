...
print("*NOTE: You may want to adjust 'valid from' to before the exp start to cover all scans.")
print("----------------------")
print("*RESULT IN CORRELATOR REPORT FORMAT:")
print("Station     fmout-gps      Used      rate     Comments")
print("[usec]       [usec]   [sec/sec]")
print("{:<10s}  {:>6.2f} {:>12.2f} {:>9.3f}e-12 {:s}".format(station,p(xx.min())*1e6, refclock*1e6,rate*1e12, reftime))
