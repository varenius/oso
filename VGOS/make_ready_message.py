...
print_lines(header)
sefda = get_lines(lines, "l   3464.40",1)
print_lines(sefda)
sefdb = get_lines(lines, "r   3464.40",1)
print_lines(sefdb)
sefdc = get_lines(lines, "l   5736.40",1)
print_lines(sefdc)
sefdd = get_lines(lines, "r   5736.40",1)
print_lines(sefdd)
sefde = get_lines(lines, "l   6856.40",1)
print_lines(sefde)
