...
def fillbbc(of, setup):
    if setup == "VGOS":
        ...
        of.write("def BBC_20m;\n")
        of.write("    BBC_assign = &BBC01 : 03 : &IF_A1;\n")
        of.write("    BBC_assign = &BBC02 : 04 : &IF_A1;\n")
        of.write("    BBC_assign = &BBC03 : 05 : &IF_B1;\n")
        of.write("    BBC_assign = &BBC04 : 06 : &IF_B1;\n")
        of.write("    BBC_assign = &BBC05 : 09 : &IF_C1;\n")
        of.write("    BBC_assign = &BBC06 : 10 : &IF_C1;\n")
        of.write("    BBC_assign = &BBC07 : 13 : &IF_D1;\n")
        of.write("    BBC_assign = &BBC08 : 14 : &IF_D1;\n")
        of.write("enddef;\n")
        of.write("def BBC_OTT;\n")
        of.write("    BBC_assign = &BBC01 : 01 : &IF_1N;\n")
        of.write("    BBC_assign = &BBC02 : 02 : &IF_1N;\n")
...
def makedatascripts(exp, ants, dnodes, setup):
    ...
    for i, a in enumerate(ants):
        ...
        if ant=="on":
            of.write("vsum -s /mnt/corrdata/{0}/{1}_on* > on.files \n".format(dn, exp))
        elif ant in ["oe", "ow"]:
            if setup == "VGOS":
                nmin = 0
                nmax = 8
            ...
            for datastream in range(nmin, nmax):
                of.write("vsum -s /mnt/corrdata/{0}/{1}_{3}*_{2} > {3}{2}.files \n".format(dn, exp, datastream, ant))
        of.close()
